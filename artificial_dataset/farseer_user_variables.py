...
#
titration_x_values = [0, 100, 300] # values for the x axis in the fitting procedure (ex. Ligand concentration)
#
...
bar_user_marks_dict = {
    'overlapped':'o',
    'review assignment':'ra',
    'low intensity':'li'
}  # keys: the string in 'Details' column in input data, value: the character to be drawn
bar_user_bar_colors_dict = {
    'overlapped':'lightblue',
    'review assignment':'lightgreen',
    'low intensity':'gold'}  # keys: the string in 'Details' column in input data, value: the character to be drawn
