...
subtitle_fn= 'Arial'  # font type for the subplot titles.
subtitle_fs= 8  # font size for the subplot titles.
subtitle_pad= 0.99  # subplot title separation from y
subtitle_weight= 'normal'  # subplot title font weight: bold, italic, etc...
x_label_fn= 'Arial'  # x-label font
x_label_fs= 8  # x-label font size
x_label_pad= 2  # x-label separation from axis
x_label_weight= 'bold'  #x_label font weight: bold, italic, etc...
y_label_fn= 'Arial'  # y-label font
y_label_fs= 8  # y-label font size
y_label_pad=3  # y-label separation from ayis
y_label_weight= 'bold'  #y_label font weight: bold, italic, etc...
x_ticks_pad=2  # x ticks pad
x_ticks_len=2  # length of xticks
y_ticks_fn='Arial'  # y-tick font name
y_ticks_fs=6  # y-tick font size
y_ticks_rot=0 # y-tick rotation
y_ticks_pad=1  # y-tick separation
y_ticks_weight= 'normal'  #y_label font weight: bold, italic, etc...on
y_ticks_len=2  # length of y ticks
y_grid_flag=True  # ON/OFF horizontal grid
y_grid_color='lightgrey'  # grid color
y_grid_linestyle='-'  # style of grid line
y_grid_linewidth=0.2  # grid line width
y_grid_alpha=0.8  # grid transparency
vspace=0.5 # vertical spacing between plots
#
