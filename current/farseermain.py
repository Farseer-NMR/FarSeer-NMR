...
def log_time_stamp(logfile_name,
        mod='a',
        state='STARTED'):
...
def gen_series_dcts(exp, series_class, fsuv,
        resonance_type='Backbone'):
    """
...
def eval_series(series_dct, fsuv,
        resonance_type='Backbone'):
    """
...
def plots_data(farseer_series, fsuv,
        resonance_type='Backbone'):
    """
