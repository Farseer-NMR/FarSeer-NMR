...
from core.fslibs.parsing_routines.user_defined_1 import parse_user1_peaklist as user1
from core.fslibs.parsing_routines.user_defined_2 import parse_user2_peaklist as user2
