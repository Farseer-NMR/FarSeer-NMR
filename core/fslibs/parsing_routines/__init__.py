...
from core.fslibs.parsing_routines.cara_full import parse_cara_full_peaklist as cara_full
from core.fslibs.parsing_routines.cara_simple import parse_cara_simple_peaklist as cara_simple
