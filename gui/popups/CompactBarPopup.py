...
class CompactBarPopup(BasePopup):
    ...
    def get_defaults(self):
        ...
        self.shade_unassigned_checkbox.setChecked(self.defaults
                                                  ["unassigned_shade"])
        self.unassigned_shade_alpha.setValue(self.defaults
                                             ["unassigned_shade_alpha"])
    ...
    def get_values(self):
        ...
        self.shade_unassigned_checkbox.setChecked(self.local_variables
                                                  ["unassigned_shade"])
        self.unassigned_shade_alpha.setValue(self.local_variables
                                             ["unassigned_shade_alpha"])

    def set_values(self):
        self.local_variables["cols_page"] = self.bar_cols.field.value()
        self.local_variables["rows_page"] = self.bar_rows.field.value()
        self.local_variables["x_ticks_fn"] = str(self.x_tick_font.fields.
                                                 currentText())
        self.local_variables["x_ticks_fs"] = self.x_tick_font_size.field.\
            value()
        self.local_variables["x_ticks_rot"] = self.x_tick_rotation.field.\
            value()
        self.local_variables["x_ticks_weight"] = str(self.x_tick_weight.fields.
                                                     currentText())
        self.local_variables["unassigned_shade"] = \
            self.shade_unassigned_checkbox.isChecked()
        self.local_variables["unassigned_shade_alpha"] = \
            self.unassigned_shade_alpha.field.value()
