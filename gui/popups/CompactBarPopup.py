...
class CompactBarPopup(QDialog):
    ...
    def __init__(self, parent=None, **kw):
        ...
        self.layout().addWidget(y_tick_padding_label, 20, 0)
        self.layout().addWidget(y_grid_colour_label, 21, 0)
        self.layout().addWidget(mark_prolines_label, 22, 0)
        self.layout().addWidget(proline_marker_label, 23, 0)
        self.layout().addWidget(user_details_label, 24, 0)
        self.layout().addWidget(mark_size_label, 25, 0)
        self.layout().addWidget(shade_unassigned_label, 26, 0)
        self.layout().addWidget(unassigned_shade_colour_label, 27, 0)
        self.layout().addWidget(unassigned_shade_alpha_label, 28, 0)
        ...
        self.layout().addWidget(self.y_tick_padding, 20, 1)
        self.layout().addWidget(self.y_grid_colour, 21, 1)
        self.layout().addWidget(self.markProlines, 22, 1)
        self.layout().addWidget(self.proline_marker, 23, 1)
        self.layout().addWidget(self.user_details, 24, 1)
        self.layout().addWidget(self.mark_font_size, 25, 1)
        self.layout().addWidget(self.shade_unassigned, 26, 1)
