...
class PreAnalysisPopup(BasePopup):
    ...
    def __init__(self, parent=None, **kw):
        ...
        self.gaussian_stdev = LabelledSpinBox(
                                              self,
                                              "Gaussian Stdev",
                                              minimum=1,
                                              step=1
                                              )
        self.gauss_x_size = LabelledSpinBox(
                                            self,
                                            "Gaussian X Size",
                                            minimum=1,
                                            step=1
    ...
    def set_values(self):
        self.local_variables["gaussian_stdev"] = \
            self.gaussian_stdev.field.value()
        self.local_variables["gauss_x_size"] = \
            self.gauss_x_size.field.value()
        self.accept()
