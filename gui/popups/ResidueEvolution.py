...
class ResidueEvolutionPopup(BasePopup):
    ...
    def set_values(self):
        ...
        # check
        self.local_variables["set_x_values"] = self.res_evo_set_x_values.isChecked()
        self.local_variables["fill_between"] = self.res_evo_plot_fill_between.isChecked()
        # text
    ...
    def get_values(self):
        ...
        self.res_evo_plot_fill_colour.get_colour(self.local_variables["fill_color"])
        self.res_evo_fit_line_colour.get_colour(self.local_variables["fit_line_color"])
