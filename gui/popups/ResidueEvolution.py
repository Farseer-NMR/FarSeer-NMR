...
class ResidueEvolutionPopup(QDialog):
    ...
    def get_defaults(self):
        ...
        self.res_evo_plot_line_width.setValue(self.default["res_evo_plot_line_width"])
        ...
        self.res_evo_plot_marker_size.setValue(self.default["res_evo_plot_marker_size"])
