...
class Test_OscillationMapPopup(unittest.TestCase):
    ...
    def setUp(self):
        ...
        print(self.defaults, self.popup.dpre_osci_color_init.fields
                         .currentText())
    ...
    def test_defaults(self):
        ...
        self.assertEqual(self.popup.dpre_osci_ref_color.fields.currentText(),
                         self.defaults["ref_color"])
        self.assertEqual(colours[self.popup.dpre_osci_color_init.fields
                         .currentText()],
                         self.defaults["color_init"])
        self.assertEqual(self.popup.dpre_osci_color_end.fields.currentText(),
                         self.defaults["color_end"])
    ...
    def test_set_values(self):
        ...
        self.popup.dpre_osci_dpre_alpha.setValue(0.5)
        self.popup.dpre_osci_smooth_lw.setValue(2)
        self.popup.dpre_osci_ref_color.select("white")
        self.popup.dpre_osci_color_init.select(colours["blue"])
        self.popup.dpre_osci_color_end.select(colours["red"])
        ...
        self.assertEqual(self.popup.dpre_osci_dpre_alpha.field.value(), 0.5)
        self.assertEqual(self.popup.dpre_osci_dpre_alpha.field.value(),
        ...
        self.assertEqual(self.popup.dpre_osci_res_highlight.isChecked(), False)
        self.assertEqual(self.popup.dpre_osci_res_highlight.isChecked(),
