...
class GeneralResidueEvolution(QDialog):
    ...
    def __init__(self, parent=None, variables=None, **kw):
        ...
        self.layout().addWidget(self.titration_x_values, 11, 0, 1, 2)
    ...
    def set_values(self, variables):
        self.variables["revo_subtitle_fn"] = self.revo_subtitle_fn.fields.currentText()
        ...
        self.variables["revo_subtitle_weight"] = self.revo_subtitle_weight.fields.currentText()
        self.variables["revo_x_label_fn"] = self.revo_x_label_fn.fields.currentText()
        ...
        self.variables["revo_x_label_weight"] = self.revo_x_label_weight.fields.currentText()
        self.variables["revo_y_label_fn"] = self.revo_y_label_fn.fields.currentText()
        ...
        self.variables["revo_y_label_weight"] = self.revo_y_label_weight.fields.currentText()
