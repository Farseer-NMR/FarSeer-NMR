...
class GeneralResidueEvolution(BasePopup):
    ...
    def __init__(self, parent=None, **kw):
        ...
        self.revo_subtitle_pad = LabelledDoubleSpinBox(self, text="Subtitle Padding", min=-100, max=100, step=0.1)
        ...
        self.revo_x_label_fs = LabelledSpinBox(self, text="X Label Font Size", min=0, step=1)
        self.revo_x_label_pad = LabelledDoubleSpinBox(self, text="X Label Padding", min=-100, max=100, step=0.1)
        ...
        self.revo_y_label_fs = LabelledSpinBox(self, text="Y Label Font Size", min=0, step=1)
        self.revo_y_label_pad = LabelledSpinBox(self, text="Y Label Padding", min=-100, max=100, step=0.1)
        ...
        self.revo_x_ticks_fs = LabelledSpinBox(self, text="X Tick Font Size", min=0, step=1)
        self.revo_x_ticks_pad = LabelledDoubleSpinBox(self, text="X Tick Padding", min=-100, max=100, step=0.1)
        self.revo_x_ticks_weight = LabelledCombobox(self, text="X Tick Font Weight", items=font_weights)
        self.revo_x_ticks_rotation = LabelledDoubleSpinBox(self, text="X Tick Rotation", min=0, max=360, step=1)

        self.revo_y_ticks_fn = FontComboBox(self, text="Y Tick Font")
        self.revo_y_ticks_fs = LabelledSpinBox(self, text="Y Tick Font Size", min=0, step=1)
        self.revo_y_ticks_pad = LabelledDoubleSpinBox(self, text="Y Tick Padding", min=-100, max=100, step=0.1)
        self.revo_y_ticks_weight = LabelledCombobox(self, text="Y Tick Font Weight", items=font_weights)
        self.revo_y_ticks_rot = LabelledSpinBox(self, text="Y Tick Rotation", min=0, max=360, step=1)
