...
class ScatterPlotPopup(QDialog):
    ...
    def get_defaults(self):
        ...
        self.cs_scatter_mk_color.select(self.default["mk_color"])
        self.cs_scatter_mk_edgecolors.select(self.default["mk_edgecolors"])
    ...
    def set_values(self, variables):
        ...
        self.variables["mk_color"] = self.cs_scatter_mk_color.fields.currentText()
        self.variables["mk_edgecolors"] = self.cs_scatter_mk_edgecolors.fields.currentText()
    ...
    def get_values(self):
        ...
        self.cs_scatter_mk_color.select(','.join([x for x in self.variables["mk_color"]]))
        self.cs_scatter_mk_edgecolors.select(','.join([x for x in self.variables["mk_edgecolors"]]))
