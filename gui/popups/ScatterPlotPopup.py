...
class ScatterPlotPopup(QDialog):
    ...
    def __init__(self, parent=None, variables=None, **kw):
        ...
        self.cs_scatter_mk_start_color = LabelledLineEdit(self, "Mark Start Colour (hex)")
        self.cs_scatter_mk_end_color = LabelledLineEdit(self, "Mark End Colour (hex)")
        self.cs_scatter_markers = LabelledLineEdit(self, "Sequential Markers")
        self.cs_scatter_mk_color = LabelledLineEdit(self, "Mark Colour (hex)")
    ...
    def get_defaults(self):
        ...
        self.cs_scatter_mk_start_color.field.setText(self.default["mk_start_color"])
        self.cs_scatter_mk_end_color.field.setText(self.default["mk_end_color"])
    ...
    def set_values(self, variables):
        ...
        self.variables["mk_start_color"] = self.cs_scatter_mk_start_color.field.text()
        self.variables["mk_end_color"] = self.cs_scatter_mk_end_color.field.text()
        self.variables["markers"] = list(self.cs_scatter_markers.field.text())
        self.variables["mk_color"] = list(self.cs_scatter_mk_color.field.text())
        self.variables["mk_edgecolors"] = list(self.cs_scatter_mk_edgecolors.field.text())
    ...
    def get_values(self):
        ...
        self.cs_scatter_mk_start_color.field.setText(self.variables["mk_start_color"])
        self.cs_scatter_mk_end_color.field.setText(self.variables["mk_end_color"])
        self.cs_scatter_markers.field.setText(', '.join(self.variables["markers"]))
        self.cs_scatter_mk_color.field.setText(','.join([x for x in self.variables["mk_color"]]))
        self.cs_scatter_mk_edgecolors.field.setText(','.join([x for x in self.variables["mk_edgecolors"]]))
