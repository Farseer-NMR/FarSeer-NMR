...
class SeriesPlotPopup(BasePopup):
    ...
    def get_defaults(self):
        self.tplot_subtitle_fn.select(self.defaults["subtitle_fn"])
        self.tplot_subtitle_fs.setValue(self.defaults["subtitle_fs"])
        self.tplot_subtitle_weight.select(self.defaults["subtitle_weight"])
        self.tplot_subtitle_pad.setValue(self.defaults["subtitle_pad"])
        self.tplot_x_label_fn.select(self.defaults["x_label_fn"])
        self.tplot_x_label_fs.setValue(self.defaults["x_label_fs"])
        self.tplot_x_label_pad.setValue(self.defaults["x_label_pad"])
        self.tplot_x_label_weight.select(self.defaults["x_label_weight"])
        self.tplot_y_label_fn.select(self.defaults["y_label_fn"])
        self.tplot_y_label_fs.setValue(self.defaults["y_label_fs"])
        self.tplot_y_label_pad.setValue(self.defaults["y_label_pad"])
        self.tplot_y_label_weight.select(self.defaults["y_label_weight"])
        self.tplot_x_ticks_pad.setValue(self.defaults["x_ticks_pad"])
        self.tplot_x_ticks_len.setValue(self.defaults["x_ticks_len"])

        self.tplot_y_ticks_fn.select(self.defaults["y_ticks_fn"])
        self.tplot_y_ticks_fs.setValue(self.defaults["y_ticks_fs"])
        self.tplot_y_ticks_rot.setValue(self.defaults["y_ticks_rot"])
        self.tplot_y_ticks_pad.setValue(self.defaults["y_ticks_pad"])
        self.tplot_y_ticks_weight.select(self.defaults["y_ticks_weight"])
        self.tplot_y_ticks_len.setValue(self.defaults["y_ticks_len"])
        self.tplot_y_grid_flag.setChecked(self.defaults["y_grid_flag"])
        self.tplot_y_grid_color.select(self.defaults["y_grid_color"])
        self.tplot_y_grid_linestyle.select(self.defaults["y_grid_linestyle"])
        self.tplot_y_grid_linewidth.setValue(self.defaults["y_grid_linewidth"])
        self.tplot_y_grid_alpha.setValue(self.defaults["y_grid_alpha"])
