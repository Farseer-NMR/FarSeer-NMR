...
class SeriesPlotPopup(BasePopup):
    ...
    def __init__(self, parent=None, **kw):
        ...
        self.tag_cartoon_ls = LabelledCombobox(
                                               self,
                                               "Tag Pin Line Style",
                                               items=line_styles
                                               )
    ...
    def set_values(self):
        self.local_variables["subtitle_fn"] = \
            str(self.series_subtitle_fn.fields.currentText())
        self.local_variables["subtitle_fs"] = \
            self.series_subtitle_fs.field.value()
        self.local_variables["subtitle_pad"] = \
            self.series_subtitle_pad.field.value()
        self.local_variables["subtitle_weight"] = \
            str(self.series_subtitle_weight.fields.currentText())
        self.local_variables["x_label_fn"] = \
            str(self.series_x_label_fn.fields.currentText())
        self.local_variables["x_label_fs"] = \
            self.series_x_label_fs.field.value()
        self.local_variables["x_label_pad"] = \
            self.series_x_label_pad.field.value()
        self.local_variables["x_label_weight"] = \
            str(self.series_x_label_weight.fields.currentText())
        self.local_variables["y_label_fn"] = \
            str(self.series_y_label_fn.fields.currentText())
        self.local_variables["y_label_fs"] = \
            self.series_y_label_fs.field.value()
        self.local_variables["y_label_pad"] = \
            self.series_y_label_pad.field.value()
        self.local_variables["y_label_weight"] = \
            str(self.series_y_label_weight.fields.currentText())

        self.local_variables["x_ticks_pad"] = \
            self.series_x_ticks_pad.field.value()
        self.local_variables["x_ticks_len"] = \
            self.series_x_ticks_len.field.value()

        self.local_variables["y_ticks_fn"] = \
            str(self.series_y_ticks_fn.fields.currentText())
        self.local_variables["y_ticks_fs"] = \
            self.series_y_ticks_fs.field.value()
        self.local_variables["y_ticks_rot"] = \
            self.series_y_ticks_rot.field.value()
        self.local_variables["y_ticks_pad"] = \
            self.series_y_ticks_pad.field.value()

        self.local_variables["y_ticks_weight"] = \
            str(self.series_y_ticks_weight.fields.currentText())
        self.local_variables["y_ticks_len"] = \
            self.series_y_ticks_len.field.value()
        self.local_variables["y_grid_flag"] = \
            self.series_y_grid_flag.isChecked()
        ...
        self.local_variables["y_grid_linewidth"] = \
            self.series_y_grid_linewidth.field.value()
        self.local_variables["y_grid_alpha"] = \
            self.series_y_grid_alpha.field.value()

        self.local_variables["theo_pre_color"] = \
            self.theo_pre_color.fields.currentText()
        ...
        self.local_variables["tag_cartoon_lw"] = \
            self.tag_cartoon_lw.field.value()
        self.local_variables["tag_cartoon_ls"] = \
            self.tag_cartoon_ls.fields.currentText()
        self.accept()
