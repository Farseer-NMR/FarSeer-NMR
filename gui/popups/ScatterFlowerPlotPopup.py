...
class ScatterFlowerPlotPopup(BasePopup):
    ...
    def __init__(self, parent=None, **kw):
        ...
        self.x_label_fs = LabelledSpinBox(
                                          self,
                                          "X Label Font Size",
                                          minimum=0,
                                          step=1
                                          )
        self.x_label_pad = LabelledDoubleSpinBox(self,
                                                 "X Label Padding",
                                                 minimum=-100,
                                                 maximum=100,
                                                 step=0.1
                                                 )
        self.x_label_weight = LabelledCombobox(
                                               self,
        ...
        self.y_label_fs = LabelledSpinBox(
                                          self,
                                          "Y Label Font Size",
                                          minimum=0,
                                          step=1
                                          )
        self.y_label_pad = LabelledDoubleSpinBox(self,
                                                 "Y Label Padding",
                                                 minimum=-100,
                                                 maximum=100,
                                                 step=0.1
                                                 )
        self.y_label_weight = LabelledCombobox(self,
                                               text="Y Label Font Weight",
                                               items=font_weights
                                               )

        self.x_ticks_fn = FontComboBox(self, "X Tick Font")
        self.x_ticks_fs = LabelledSpinBox(self,
                                          "X Tick Font Size",
                                          minimum=0,
                                          step=1
                                          )
        self.x_ticks_pad = LabelledDoubleSpinBox(self,
                                                 "X Tick Padding",
                                                 minimum=-100,
                                                 maximum=100,
                                                 step=0.1
                                                 )
        self.x_ticks_weight = LabelledCombobox(self,
                                               text="X Tick Weight",
                                               items=font_weights
                                               )
        ...
        self.y_ticks_fs = LabelledSpinBox(
                                          self,
                                          "Y Tick Font Size",
                                          minimum=0,
                                          step=1
                                          )
        self.y_ticks_pad = LabelledDoubleSpinBox(self,
                                                 "Y Tick Padding",
                                                 minimum=-100,
                                                 maximum=100,
                                                 step=0.1
                                                 )
        self.y_ticks_weight = LabelledCombobox(self,
                                               text="Y Tick Weight",
                                               items=font_weights
                                               )
    ...
    def get_defaults(self):
        ...
        self.y_label_pad.setValue(
            self.defaults["y_label_pad"])
        self.y_label_weight.select(
        ...
        self.x_ticks_pad.setValue(
            self.defaults["x_ticks_pad"])
        self.x_ticks_weight.select(
            self.defaults["x_ticks_weight"])
        self.x_ticks_rot.setValue(
        ...
        self.y_ticks_pad.setValue(
            self.defaults["y_ticks_pad"])
        self.y_ticks_weight.select(
            self.defaults["y_ticks_weight"])
        self.y_ticks_rot.setValue(
    ...
    def set_values(self):
        ...
        self.local_variables["x_label_weight"] = \
            self.x_label_weight.fields.currentText()

        self.local_variables["y_label_fn"] = \
            self.y_label_fn.fields.currentText()
        ...
        self.local_variables["y_label_weight"] = \
            self.y_label_weight.fields.currentText()
        ...
        self.local_variables["x_ticks_fn"] = \
            self.x_ticks_fn.fields.currentText()
        ...
        self.local_variables["y_ticks_fn"] = \
            self.y_ticks_fn.fields.currentText()
