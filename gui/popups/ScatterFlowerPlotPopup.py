...
class ScatterFlowerPlotPopup(BasePopup):
    ...
    def __init__(self, parent=None, **kw):
        ...
        self.cs_scatter_flower_mksize = LabelledSpinBox(self, "Mark Size", minimum=0, step=1)
        ...
        self.cs_scatter_flower_x_label_fs = LabelledSpinBox(self, "X Label Font Size", minimum=0, step=1)
        self.cs_scatter_flower_x_label_pad = LabelledDoubleSpinBox(self, "X Label Padding", minimum=-100, maximum=100, step=0.1)
        ...
        self.cs_scatter_flower_y_label_fs = LabelledSpinBox(self, "Y Label Font Size", minimum=0, step=1)
        self.cs_scatter_flower_y_label_pad = LabelledDoubleSpinBox(self, "Y Label Padding", minimum=-100, maximum=100, step=0.1)
        ...
        self.cs_scatter_flower_x_ticks_fs = LabelledSpinBox(self, "X Tick Font Size", minimum=0, step=1)
        self.cs_scatter_flower_x_ticks_pad = LabelledDoubleSpinBox(self, "X Tick Padding", minimum=-100, maximum=100, step=0.1)
        self.cs_scatter_flower_x_ticks_weight = LabelledCombobox(self, text="X Tick Weight", items=font_weights)
        self.cs_scatter_flower_x_ticks_rot = LabelledSpinBox(self, "X Tick Rotation", minimum=0, maximum=360, step=1)

        self.cs_scatter_flower_y_ticks_fn = FontComboBox(self, "Y Tick Font")
        self.cs_scatter_flower_y_ticks_fs = LabelledSpinBox(self, "Y Tick Font Size", minimum=0, step=1)
        self.cs_scatter_flower_y_ticks_pad = LabelledDoubleSpinBox(self, "Y Tick Padding", minimum=-100, maximum=100, step=0.1)
        self.cs_scatter_flower_y_ticks_weight = LabelledCombobox(self, text="Y Tick Weight", items=font_weights)
        self.cs_scatter_flower_y_ticks_rot = LabelledSpinBox(self, "Y Tick Rotation", minimum=0, maximum=360, step=1)
