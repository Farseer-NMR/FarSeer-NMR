...
class ExtendedBarPopup(QDialog):
    ...
    def __init__(self, parent=None, **kw):
        ...
        bar_y_title = QLabel("Y Title Size", self)
        ...
        self.layout().addWidget(bar_y_title, 9, 0)
        ...
        self.bar_y_title = QDoubleSpinBox()
        ...
        self.layout().addWidget(self.bar_y_title, 9, 1)
    ...
    def set_defaults(self):
        ...
        self.bar_y_title.setValue(1.05)
        self.title_font.setText('Arial')
        self.title_font_size.setValue(10)
