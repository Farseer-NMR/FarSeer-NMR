...
class ExtendedBarPopup(BasePopup):
    ...
    def __init__(self, parent=None, **kw):
        ...
        self.x_tick_font_weight = LabelledCombobox(self, "X Tick Font Weight",
                                                   items=font_weights
                                                   )
    ...
    def set_values(self):
        ...
        self.local_variables["x_ticks_rot"] = self.x_tick_rotation.field.\
            value()
        self.local_variables["x_ticks_weight"] = str(self.x_tick_font_weight.
                                                     fields.currentText())
        self.local_variables["x_ticks_color_flag"] = self.x_tick_colour.\
            isChecked()
        self.accept()
