...
class BarPlotPopup(BasePopup):
    ...
    def __init__(self, parent=None, **kw):
        ...
        self.bar_threshold_alpha = LabelledDoubleSpinBox(
            self, "Stdev Threshold Alpha", minimum=0, maximum=1, step=0.1)
        self.bar_threshold_linewidth = LabelledDoubleSpinBox(
            self, text="Stdev Threshold Line Width", minimum=0, step=0.1)
        self.user_mark_font_size = LabelledSpinBox(
            self, "Mark Font Size", minimum=0, step=1)
        ...
        self.colour_user_details = LabelledCheckbox(self,
                                                    "Colour User Details")
    ...
    def launch_user_marker_popup(self):
        UserMarksPopup(variables=self.local_variables["user_marks_dict"]).\
            launch()
    ...
    def get_values(self):
        ...
        self.bar_alpha.setValue(
            self.local_variables["bar_alpha"])
        self.bar_linewidth.setValue(
    ...
    def set_values(self):
        ...
        self.local_variables["bar_width"] = \
            self.bar_width.field.value()
        self.local_variables["bar_alpha"] = \
            self.bar_alpha.field.value()
        self.local_variables["bar_linewidth"] = \
        ...
        self.local_variables["threshold_alpha"] = \
            self.bar_threshold_alpha.field.value()
        self.local_variables["mark_fontsize"] = \
