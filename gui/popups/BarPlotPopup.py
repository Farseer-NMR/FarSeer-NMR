...
class BarPlotPopup(BasePopup):
    ...
    def __init__(self, parent=None, **kw):
        ...
        self.bar_width = LabelledDoubleSpinBox(self, text="Bar Width", minimum=0, maximum=1, step=0.1)
        self.bar_alpha = LabelledDoubleSpinBox(self, text="Bar Transparency", minimum=0, maximum=1, step=0.1)
        self.bar_linewidth = LabelledDoubleSpinBox(self, text="Bar Line Width", minimum=0, step=0.1)
        ...
        self.bar_threshold_alpha = LabelledDoubleSpinBox(self, "Stdev Threshold Alpha", minimum=0, maximum=1, step=0.1)
        self.bar_threshold_linewidth = LabelledDoubleSpinBox(self, text="Stdev Threshold Line Width", minimum=0, step=0.1)
