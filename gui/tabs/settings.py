...
class Settings(BaseWidget):
    ...
    def __init__(self, parent=None, gui_settings=None, footer=None):
        ...
        self.tplot_button = QPushButton("General Settings", self)
        self.tplot_button.clicked.connect(partial(self.show_popup, SeriesPlotPopup))
        self.revo_button = QPushButton("General Evolution Settings", self)
        self.revo_button.clicked.connect(partial(self.show_popup, GeneralResidueEvolution))
        self.bar_button = QPushButton("Bar Settings", self)
        ...
        self.scatter_button.clicked.connect(partial(self.show_popup, ScatterPlotPopup))
        self.scatter_flower_button = QPushButton("Settings", self)
        self.scatter_flower_button.clicked.connect(partial( self.show_popup, ScatterFlowerPlotPopup))
        ...
        self.figure_format = LabelledCombobox(
            self,
            "Figure Format",
            items=[
                'pdf',
        ...
        self.csp_alpha = LabelledDoubleSpinBox(
            self,
            text="CSP Alpha",
            minimum=0.01,
            maximum=1,
        ...
        self.plot_height_ratio = LabelledCheckbox(
            self,
            text="Height Ratio",
        ...
        self.plot_F1_y_scale = LabelledDoubleSpinBox(self, text="", minimum=0, step=0.1)
        self.plot_F2_y_scale = LabelledDoubleSpinBox(self, text="", minimum=0, step=0.1)
        self.plot_CSP_y_scale = LabelledDoubleSpinBox(self, text="", minimum=0, step=0.1)
        self.plot_height_y_scale = LabelledDoubleSpinBox(self, text="", minimum=0, step=0.1)
        self.plot_volume_y_scale = LabelledDoubleSpinBox(self, text="", minimum=0, step=0.1)
        restraint_label = QLabel("Y Axis Label")
        axis_label = QLabel("Parameter Name")
        ...
        restraint_groupbox.layout().addWidget(restraint_label, 0, 2)
        restraint_groupbox.layout().addWidget(axis_label, 0, 1)
        ...
        restraint_groupbox.layout().addWidget(self.plot_F1_y_label, 1, 2)
        restraint_groupbox.layout().addWidget(self.plot_F2_y_label, 2, 2)
        restraint_groupbox.layout().addWidget(self.plot_CSP_y_label, 3, 2)
        restraint_groupbox.layout().addWidget(self.plot_height_y_label, 4, 2)
        restraint_groupbox.layout().addWidget(self.plot_volume_y_label, 5, 2)
        restraint_groupbox.layout().addWidget(self.plot_F1_calccol, 1, 1)
        restraint_groupbox.layout().addWidget(self.plot_F2_calccol, 2, 1)
        restraint_groupbox.layout().addWidget(self.plot_CSP_calccol, 3, 1)
        restraint_groupbox.layout().addWidget(self.plot_height_calccol, 4, 1)
        restraint_groupbox.layout().addWidget(self.plot_volume_calccol, 5, 1)
        ...
        pre_groupbox.setTitle("PRE Analysis")
