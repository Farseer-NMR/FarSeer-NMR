...
class PeakListArea(QWidget):
    ...
    def __init__(self, parent, gui_settings):
        ...
        self.scrollContents.setMinimumSize(
            gui_settings['scene_width'],
    ...
    def show_update_warning(self):
        ...
        msg.setInformativeText(
            "Do you want to all peaklists from the "
...
class PeakListLabel(QGraphicsTextItem):
    ...
    def remove_item(self):
        self.setHtml(
            '<div style="color: %s; font-size: 10pt;">%s</div>' \
